...
import com.example.anew.ui.fragment.common.dialog.EditGroupNameDiaLog
import com.example.anew.ui.fragment.common.adapter.ChatRoomAdapter
import com.example.anew.ui.fragment.common.adapter.DeleteMemberAdapter
...
class ChatRoomFragment : Fragment() {
    ...
    private fun setUpViewModel(chatId: String) {
        ...
        viewModel.getFriendListData(MyHelper.user!!.uid)
    ...
    private fun setupLeaveGroupLogic(dialog: AlertDialog) {
        ...
        dialogLeaveBinding.btnConfirm.setOnClickListener {
            viewLifecycleOwner.lifecycleScope.launch {
                try {
                    removeMember(chatType,chatId,MyHelper.user!!.uid)
                    Snackbar.make(
                        binding.root,
